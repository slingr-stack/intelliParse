    ...
    ingestorForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            for (const file of validatedFiles) {
                ...
                const response = await fetch('https://aiagents.slingrs.io/prod/runtime/api/files', {
                    method: 'POST',
                    headers: {
                        'Accept': 'application/json',
                        'token': 'IshHYC1RHj0PQqnDfxUeZmI9CWspvdtk'
                    },
                    body: fileData,
                });
            ...
            const response2 = await fetch('https://aiagents.slingrs.io/prod/runtime/api/data/dummyEntity/createPublicData/', {
